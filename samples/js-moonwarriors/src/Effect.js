var flareEffect = function (flare,target, callback) {
    ...
    flare.runAction(cc.Sequence.create(opacityAnim, biggeAnim, opacDim, killflare, onComplete));
    flare.runAction(moveAnim);
    flare.runAction(rotateAnim);
